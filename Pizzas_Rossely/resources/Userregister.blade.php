          ...
          <div class="tile">
            ...
            <div class="tile-body">
                <form class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                        <a type="submit" href="users.html" class="btn btn-primaryV rounded submit py-3 px-4">
                            Guardar
                        </a>
                        <a type="submit" href="users.html" class="btn btn-primaryG rounded submit py-3 px-4">
                            Cancelar
                        </a>
                        </div>
                    </div>
