  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <p><a class="btn btn-primaryV icon-btn" href="Userregister.html"><i class="fa fa-plus"></i>Agregar usuario</a></p>
            <div class="tile-body">
              <table class="table table-striped">
                ...
                <tbody align="center">
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primaryA" href="Userregister.html"><i class="fa fa-lg fa-edit"></i></a>
