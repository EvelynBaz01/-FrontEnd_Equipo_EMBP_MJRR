        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Ponte en contacto con nosotros</h1>
            </div>
    		...
    		<div class="row no-gutters d-md-flex align-items-center">
    			<div class="col-md-6 d-flex align-self-stretch">
					...
					function initMap() {
						...
						center: {lat: 18.7633, lng: -97.2235},
						zoom: 13,
						});
						var marker = new google.maps.Marker({
						position: {lat: 18.763322, lng: -97.223524},
						map: map,
	    		...
	    		<div class="col-md-6 appointment ftco-animate">
	    			<h3 class="mb-3">Proporcionanos tu información</h3>
	    			<form action="#" class="appointment-form">
              <div class="form-group">
	              <input type="text" class="form-control" name="introducir_nombre" id="nombre" required="obligatorio" minlength="3" maxlength="40" placeholder="Nombre Completo">
	            </div>
              <div class="row">
            		<div class="col-md-6">
	                <div class="form-group">
	                  <input type="number" class="form-control" name="introducir_telefono" id="telefono" minlength="10" maxlength="10" placeholder="Teléfono">
	                </div>
                </div>
                <div class="col-md-6">
	                <div class="form-group">
	                  <input type="email" class="form-control" name="introducir_email" id="email" required="obligatorio" pattern=".+@globex\.com" size="30" placeholder="Correo Electrónico">
	                </div>
	                </div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="introducir_nombre" id="nombre" required="obligatorio" minlength="3" maxlength="20" placeholder="Asunto">
              </div>
	    				<div class="form-group">
	              <textarea name="introducir_mensaje" cols="30" rows="3" class="form-control" id="mensaje" required="obligatorio" minlength="20" maxlength="255" placeholder="Deja aquí tu comentario..."></textarea>
	            </div>
